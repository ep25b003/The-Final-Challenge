...
| k (aero drag) | 2.575 × 10⁻³ W/(km/h)³| k = 1/2ρCdA = 1/2×1.2×0.13×1.54 |
...
| η_panel | 24% 
| A_panel | 6.0 m²
| Peak P_solar | 1545 W| At solar noon |
...
## Results
BASE ROUTE:  8:00 AM → 11:19 AM  (3.64 h)
  Speed profile: ~77 km/h throughout
  Battery on arrival: 1600 Wh (SOC 32%)

CONTROL STOP: 11:19 → 11:49 (30 min, solar charging)

LOOP PHASE: 11:49 PM → 5:00 PM
  N_loops  = 8
  v_loop   = 60.92 km/h (= v_min_time)
  Feasible range: [60.92, 78.69] km/h
  Battery at 5PM: 3369 Wh (SOC 67.4%)
TOTAL DISTANCE: 560 km (280 base + 8 × 35 loops)
### Analytical Insights
...
3. Loop speed range is tight [60.92, 78.69 km/h] because the energy budget is limited (only 600 Wh available for loops). This narrow range confirms our Q2 analysis: the energy constraint is binding at the optimum.

4. Day 3 surplus: ending at SOC 67.4% gives a 3369 Wh buffer -- enough for emergency driving even with zero solar the next morning.
APIs used:
